classdef COrderList < handle
    ...
    methods
        ...
        function [obj] = addEntrust(obj, e)
            if (obj.currentID ~= 0)
                obj.maxOrderNum = obj.maxOrderNum + 1;
                obj.combiNo(obj.maxOrderNum) = cell(1,1);
                obj.stockholderID(obj.maxOrderNum)       = cell(1,1);
                obj.marketNo(obj.maxOrderNum)            = 0;
                obj.stockCode(obj.maxOrderNum)           = cell(1,1);
                obj.entrustDirection(obj.maxOrderNum)    = 0;
                obj.futuresDirection(obj.maxOrderNum)    = -1;
                obj.coveredFlag(obj.maxOrderNum)         = 0;
                obj.priceType(obj.maxOrderNum)           = 0;
                obj.entrustPrice(obj.maxOrderNum)        = 0;
                obj.entrustAmount(obj.maxOrderNum)       = 0;
                obj.extsystemId(obj.maxOrderNum)         = 0;
            end
            ...
            obj.fillOrder(obj.optCombiNo, str2double(e.marketNo), e.instrumentCode, direction, ...
                e.price, e.volume, 0, offset, [], [], []);
        end
