function [errorCode,errorMsg,packet] = queryCombiFuture(self,marketNo,stockCode)
%QUERYCOMBIFUTURE 在CounterHSO32中重新包装函数QueryCombiAsset
% --------------------------
% 朱江，20160316
...
[errorCode,errorMsg,packet] = QueryCombiAsset(connection,token,accountCode,combiNo,marketNo,stockCode, 2);
