function [errorCode,errorMsg,packet] = queryOptEntrusts(self, entrustNo)
...
[errorCode,errorMsg,packet] = QueryEntrusts(connection,token,accountCode,combiNo,entrustNo, 3);
