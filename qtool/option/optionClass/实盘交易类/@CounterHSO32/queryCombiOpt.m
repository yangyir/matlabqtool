function [errorCode,errorMsg,packet] = queryCombiOpt(self,marketNo,stockCode)
...
[errorCode,errorMsg,packet] = QueryCombiAsset( connection,token,accountCode,combiNo,marketNo,stockCode, 3);
