...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    code = mxArrayToString(prhs[0]);
    
    QueryQuote(code, tempQuote);
    
    // prepare mkt data:
    // 最新价，开盘价，最高价，最低价，成交量，交易时间
    mktdatabase[0] = tempQuote.last_;
    mktdatabase[1] = tempQuote.open_;
    mktdatabase[2] = tempQuote.high_;
    mktdatabase[3] = tempQuote.low_;
    mktdatabase[4] = tempQuote.amount_;
    mktdatabase[5] = tempQuote.pre_close_;
    mktdatabase[6] = tempQuote.pre_settle_;
    ...
    levelI = 0;
    // prepare level data
    leveldata[levelI] = tempQuote.bid_p1_;
    leveldata[levelI + 5] = tempQuote.bid_q1_;
    leveldata[levelI + 10] = tempQuote.ask_p1_;
    leveldata[levelI + 15] = tempQuote.ask_q1_;
    
    levelI = 1;
    leveldata[levelI] = tempQuote.bid_p2_;
    leveldata[levelI + 5] = tempQuote.bid_q2_;
    leveldata[levelI + 10] = tempQuote.ask_p2_;
    leveldata[levelI + 15] = tempQuote.ask_q2_;
    
    levelI = 2;
    leveldata[levelI] = tempQuote.bid_p3_;
    leveldata[levelI + 5] = tempQuote.bid_q3_;
    leveldata[levelI + 10] = tempQuote.ask_p3_;
    leveldata[levelI + 15] = tempQuote.ask_q3_;
    
    levelI = 3;
    leveldata[levelI] = tempQuote.bid_p4_;
    leveldata[levelI + 5] = tempQuote.bid_q4_;
    leveldata[levelI + 10] = tempQuote.ask_p4_;
    leveldata[levelI + 15] = tempQuote.ask_q4_;
    
    levelI = 4;
    leveldata[levelI] = tempQuote.bid_p5_;
    leveldata[levelI + 5] = tempQuote.bid_q5_;
    leveldata[levelI + 10] = tempQuote.ask_p5_;
