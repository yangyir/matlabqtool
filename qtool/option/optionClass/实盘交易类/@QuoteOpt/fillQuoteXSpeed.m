function [ self ] = fillQuoteXSpeed(self)
% [ self ] = fillQuoteXSpeed(self)
%  [mktdata, level_p, update_time] = xspeed_getoptquote(asset_code) 
...
[mkt, level, updatetime] = xspeed_getoptquote(num2str(self.code));
%标的最新价
s_mkt = xspeed_getoptquote(num2str(self.underCode));
self.S = s_mkt(1);
