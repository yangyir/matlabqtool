function [] = pricing_tf_design_6()
    ...
    %% 挂载payoff计算方法
    pricer.payoff_handler = @payoff_design_6;
    pricer.forward_T_step();

    % p2_rc = pricer.calc_price_recusive()
    p6 = pricer.calc_price()
    ...
    mcp.model = model;
    mcp.payoffFunctionHandler = @payoff_design_6_MC;

    p6_mc = mcp.calc_opt_price_mat()
