...
%% 
stra2 = OptStraddleTradingFusion;
...
% 挂
stra2.quoteS     = qms_.stkmap_.getQuote('510050');
...
b1.pendingEntrusts.print;

% 观察PNL
stra.monitor_book_risk(2.05,2.45);
b1.calc_m2m_pnl_etc; b1.positions
...
%%
b1.plot_position_bars

%%  多空轧差

b1.eod_netof_positions

%% 处理日末挂单
b1.eod_virtual_cancel_all_pendingEntrusts(c2);    
tic; stra.book.toExcel(); toc 
