...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function  [popupmenu_Input,nargin_num] = choosestrategypopupmenu(Configure_Gildata_Backtest)
...
set(popupmenu_Input,'callback',['clear Displaydata;','changestrategy(popupmenu_Input,Configure_Gildata_Backtest.StrategyExample,handle);']);
