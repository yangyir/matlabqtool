...
%                   channels
%         fpctk/fpctd/spctk/spctd
%                 - fast/slow percent k/d
%         index/value
...
%     - two methods are available to calculate the ema for the tsi
%     indicator.  simply comment whichever one is not desired
