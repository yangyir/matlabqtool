...
% ver1.1; Cheng,Gang; 20130425;   优化格式，正名bars
    ...
    methods (Access = 'public', Static = true, Hidden = false)
        ...
        [sig_long, sig_short]           = Alligator(bars, delta, type)
        [ sig_long, sig_short, sig_rs ] = Aroon(bars, nDay, upband, lowband, type)
        [sig_long, sig_short]           = Asi(bars, mu_up, mu_down,type)
        [sig_long,sig_short, sig_rs]    = Bbi(bars, lag1, lag2, lag3, lag4, type)
        [sig_rs]                        = Bias(bars, nDay, type)
        [ sig_long, sig_short, sig_rs]  = Bollinger( bars, wsize, wts, nstd, wlow, whigh, type)
        ...
        [sig_long, sig_short, sig_rs]   = Kdj(bars, nday, type)
